    ...
    public ErrorFrame(String error, String category) {
        ...
        switch (category) {
            case "vægt"          :  errorOne.setText("fejl: " + error + " i kategorien: " + category); 
                                ...
                                break;
            case "telefon nummer":   formatFix = "8 cifre";
                                     correctExample = "22446688";
                                break;
            case "produkt navn"  :   errorOne.setText("Der er ikke indtastet et navn på produktet"); 
                                     fixOne.setText("Navnefeltet må ikke være tomt");
                                break;
            case "produkt antal" :   formatFix = "heltal";
                                     correctExample ="2";
                                break;
            case "produkt pris"  :    formatFix = "heltal eller kommatal";
                                     correctExample ="2 eller 2.5";
                                break;
        }
        frameBuild();
